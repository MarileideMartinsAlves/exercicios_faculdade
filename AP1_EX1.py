...
valorproduto = float(input('Digite o valor do produto: '))  # valor unitário do produto do tipo flutuante
quantidadeproduto = int(input('Digite a quantidade do produto: '))  # quantidade de produto do tipo inteiro
comprasemdesconto = float(valorproduto*quantidadeproduto)  # cálculo da compra sem desconto
